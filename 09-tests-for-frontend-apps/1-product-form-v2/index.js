...
export default class ProductForm {
  ...
  async render () {
    ...
    if(this.productId) {
      const productDataPromise = this.loadData();
      const [categoriesData, productData = result[0]] = await Promise.all([
        categoriesPromise, productDataPromise
      ]);
      ...
      this.categoriesData = await categoriesPromise();
      this.productData = this.defaultData;
